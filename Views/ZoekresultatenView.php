...
class ZoekresultatenView {
    ...
    public function ZoekresultatenView($query) {
        ...
        $this->resultaten = $this->dbfunctions->ZoekenNaarFilms($query);
    ...
    public function Render() {
        ...
        if (count($this->singles) == 0) { echo "<div class=\"GeenFilmsGevonden\">Er zijn geen films gevonden die aan uw zoekcriteria voldoen.</div>"; }
        else {
                    echo ("  
