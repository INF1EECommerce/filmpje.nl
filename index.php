...
$top10view->Render(); ?>
                    ...
                    <td>
                        <div id="mainContent">
                            <div id="pagebanner">
<?php $carouselView = new CarouselView();
$carouselView->Render(); ?>    
                            </div>
                            <div id="schedule">
                                <p>Nu bij Filmpje</p>
                                ...
                                <?php
                                $vandaagMorgenOvermorgenView = new VandaagMorgenOvermorgenView();
                                $vandaagMorgenOvermorgenView->Render();
                                ?>
                            ...
                            <div id="specialsDiv">
<?php $specialsAccordionView = new SpecialAccordionView();
$specialsAccordionView->Render(); ?>
                            </div>
                        </div>
                    </td>
                </tr>
